...
public class FootControllerIK : MonoBehaviour
{
    ...
    /// <summary>
    /// Target for left knee inverse kinematics. �reates new plane for left leg rotation.
    /// </summary>
    ...
    /// <summary>
    /// Target for right knee inverse kinematics. �reates new plane for right leg rotation.
    /// </summary>
